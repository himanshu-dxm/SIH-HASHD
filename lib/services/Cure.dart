class Cure {
  ...
  static String? getCure(String diseaseName) {
    diseaseName = diseaseName.replaceAll('\'', '');
    print(diseaseName.replaceAll('\'', ''));
    print(diseaseName=='Tomato___Late_blight');
    print(disease["Tomato___Late_blight"]);//Tomato___Late_blight
    print(disease[diseaseName].toString());
    print("Sending the disease cure as :"+disease[diseaseName].toString());
